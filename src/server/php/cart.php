...
$db = mysqli_connect("127.0.0.1", "root", "lin147258", "YQW");
$type = $_REQUEST["type"];
$id = $_REQUEST["id"];
...
if($type == "add")
{
  ...
  $sql = "SELECT cart.*,goods.title,goods.src,goods.term,goods.price,goods.Trade,goods.barcode FROM cart , goods WHERE cart.good_id = goods.good_id AND user_id =$id";
